    ...
    if train:
        with open(json_path) as json_file:
            ...
            for key, value in classes.items():
                if not os.path.exists('train2014/{}'.format(value)):
                    os.mkdir('train2014/{}'.format(value))
            ...
            for i, annotation in enumerate(annotations, 1):
                ...
                dst_file = ('train2014/{}/{}'.format(classes[category_id], file_name))
                src_file = '/home/dexter/Downloads/train2014/{}'.format(file_name)
                ...
                if os.path.exists('train2014/{}/{}'.format(classes[category_id], file_name)):  # If copy successfully
                    #  print("File " + 'train2014/{}/{}'.format(classes[category_id], file_name) + " is copied")
                    image_count += 1
                else:
                    print("Copy failed!")
            ...
            print("Finish splitting dataset from {}".format(json_path))


split_data('instances_train2014.json', train=True)